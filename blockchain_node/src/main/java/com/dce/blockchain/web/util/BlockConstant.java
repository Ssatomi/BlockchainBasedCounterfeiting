...
public class BlockConstant {
	...
	//producer请求商品信息以更新
	public final static int QUERY_COMMODITY_UPDATE = 18;

	//返回商品码与区块索引
	public final static int RESPONSE_COMMODITY_INDEX = 19;

	//返回商品信息
	public final static int RESPONSE_COMMODITY_DATA = 20;
